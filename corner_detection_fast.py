...
def show_image_with_corners(image_name: str) -> any:
    ...
    cornered_image_with_nms = cv2.drawKeypoints(image, corners_with_nms, None, color=(255,0,0))
    cornered_image_without_nms = cv2.drawKeypoints(image, corners_without_nms, None, color=(255,0,0))
    common_functions.show_image("cornered_image_with_nms", cornered_image_with_nms)
    common_functions.show_image("cornered_image_without_nms", cornered_image_without_nms)
